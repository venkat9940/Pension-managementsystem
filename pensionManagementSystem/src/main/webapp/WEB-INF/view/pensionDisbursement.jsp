...
<body    
	style=" background-size: auto; background-repeat: no-repeat; background-position: inherit;">
	<header>
		<nav class="navbar bg-light transparent">
			<h3 class=" text-center display-5 text-uppercase font-bold"
				style="margin-top: 5px; font-family: sans-serif; color: #000000">
				<i class="fab fa-google-wallet"> </i>&nbsp; Pension Management
				Portal
			</h3>
			<a href="/logout" style="align: right;color: #000000">Logout</a>
		</nav>
	</header>
	<section>
		<div class="container">
			...
			<div class="center" style="margin-left: 80px; background-color: rgba(255, 255, 255, 0.5);">
