...
public class UserDetailsTest {
	...
	public void testGetCorrectUsernameFromDatabase() {
		...
		User user = new User(1, "deekshith", "password");

		when(repository.findByUsername("deekshith")).thenReturn(user);

		UserDetails userDetails = customUserDetailsService.loadUserByUsername("deekshith");
