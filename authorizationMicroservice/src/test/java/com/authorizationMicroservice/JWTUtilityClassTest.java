...
public class JWTUtilityClassTest {
	...
	public void testGenerateToken() {
		userDetails = new User("deekshith", "password", new ArrayList<>());
	...
	public void testValidateToken() {
		userDetails = new User("priyanka", "password", new ArrayList<>());
		String token = jwtUtil.generateToken(userDetails);
	...
	public void testValidateTokenWithIncorrectUsername() {
		userDetails = new User("deek", "password", new ArrayList<>());
		String token = jwtUtil.generateToken(userDetails);
	...
	public void extractUsernameTest() {
		...
		assertEquals(username, "deekshith");
	}
